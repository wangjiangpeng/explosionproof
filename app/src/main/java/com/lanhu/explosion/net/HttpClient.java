...
public class HttpClient {
    ...
    protected SSLSocketFactory createSSLSocketFactory(RequestParam param) {
        ...
        try {
            // 信任证书加载
            trustInputStream = param.getContext().getResources().openRawResource(param.getTrustStoreId());
            ...
            if (param.isSSLMutual()) {
                inputStream = param.getContext().getResources().openRawResource(param.getKeyStoreId());
