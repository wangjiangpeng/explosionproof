...
Java_com_io_rtmp_RTMPMuxer_open(JNIEnv* env, jobject thiz, jstring url_,
...
JNIEXPORT jint JNICALL
Java_com_io_rtmp_RTMPMuxer_writeAudio(JNIEnv* env, jobject thiz, jbyteArray data_,
...
JNIEXPORT jint JNICALL
Java_com_io_rtmp_RTMPMuxer_writeVideo(JNIEnv* env, jobject thiz, jbyteArray data_,
                                                       jint offset, jint length, jlong timestamp) {
    jbyte *data = (*env)->GetByteArrayElements(env, data_, NULL);
...
JNIEXPORT jint JNICALL
Java_com_io_rtmp_RTMPMuxer_close(JNIEnv* env, jobject thiz) {
    rtmp_close();
...
Java_com_io_rtmp_RTMPMuxer_isConnected(JNIEnv* env, jobject thiz) {
    return rtmp_is_connected() ? true : false;
}

JNIEXPORT jint JNICALL
Java_com_io_rtmp_RTMPMuxer_read(JNIEnv* env, jobject thiz, jbyteArray data_,
